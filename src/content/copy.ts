...
export const copy = {
  ...
  nav: {
    ...
    links: [
      ...
      { href: "/#kodel-gloumi", label: "Kodėl Gloumi" },
      { href: "/#meistrams", label: "Meistrams" },
  ...
  footer: {
    ...
    contacts: "Kontaktai",
    clientLinks: [
      { href: "/#atsisiusti", label: "Atsisiųsti programėlę" },
      { href: "/#kategorijos", label: "Kategorijos" },
      { href: "/#kodel-gloumi", label: "Kodėl Gloumi" },
    ],
    masterLinks: [
      { href: "/#meistrams", label: "Privalumai meistrams" },
      { href: "/#tapti-meistru", label: "Tapti meistru" },
    ],
    legalLinks: [
      { href: "/taisykles", label: "Naudojimosi taisyklės" },
      { href: "/privatumo-politika", label: "Privatumo politika" },
      { href: "/grazinimo-salygos", label: "Grąžinimo sąlygos" },
      { href: "/dac7", label: "DAC7 ir platformos skaidrumas" },
    ],
